...
const Course = ({ course, handleAddBookmark }) => {
  ...
  return (
    <div className="bg-white rounded-md">
      <div className="w-[312px] h-auto ">
        ...
        <button
          onClick={()=>handleAddBookmark(course)}
          class="mx-auto my-4 h-[40px] w-[280px] text-center flex justify-center items-center bg-blue-400 rounded-md text-lg font-semibold text-white hover:bg-orange-500  "
        >
          Select
        </button>
      </div>
